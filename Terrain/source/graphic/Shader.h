...
#include	<memory>
#include	<string>
#include	"../../package/directxtex/include/WICTextureLoader.h"
#include	"../../package/directxtex/include/DDSTextureLoader.h"
...
bool CreateComputeShader(ID3D11Device* device,						// コンピュートシェーダーオブジェクトを生成
	const char* szFileName,
	LPCSTR szEntryPoint,
	LPCSTR szShaderModel,
